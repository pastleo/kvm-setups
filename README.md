...
如果有需要可以直接參考我的 `[vm_name].xml` 設定檔：https://github.com/pastleo/kvm-setups/blob/821e2ecf8e38228f521980e7a8a4551ae1bdf703/example-etc/libvirt/qemu/%5Bvm_name%5D.xml
